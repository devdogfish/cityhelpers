---
title: "City Helpers — worker matching and delivery"
updated: "2026-09-22"
---
...
**Sources:** [existing marketing funnel](existing-marketing-funnel.html), [business context](context.html), [website and booking observations](website-and-booking.html), [open questions](open-questions.html), and `raw-transcript-context.txt`. These local notes reference the published service terms and team discussion; internal operations have not been observed.
