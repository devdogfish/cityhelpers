...
Unknowns include existing partner relationships, staff capacity, financial arrangements, and whether the organization wants resident support or labour for its own operations. Source: `current-business/team-meeting-01-transcript.txt`; process details above are proposed. See [outreach](community-outreach.html) and [open questions](open-questions.html).
