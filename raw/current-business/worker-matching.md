...
**Sources:** [existing marketing funnel](existing-marketing-funnel.md), [business context](business-context.md), [website and booking observations](../ideas-and-work/website-and-booking.md), [open questions](../looking-ahead/open-questions.md), and `source-material/ceo-discussion-transcript.txt`. These local notes reference the published service terms and team discussion; internal operations have not been observed.
