...
Unknowns: available budget, account access, baseline conversion, worker coverage, and allowable acquisition cost. Source: `source-material/team-meeting-01-transcript.txt` and the original hackathon brief. See [messaging](messaging.md) and [website](website-and-booking.md).
